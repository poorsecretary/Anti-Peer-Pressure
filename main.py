...
# GPA
print("我的GPA是{}/{}。".format(student.GPA, student.GPA_limit))
# Toefl Portion
print("我托福最高分是{},阅读{},听力{},口语{},写作{}.拼分最好是{}.".format(student.toefl,
                                                      student.toefl_r,
                                                      student.toefl_l,
                                                      student.toefl_s,
                                                      student.toefl_w,
...
# SAT portion
print("关于SAT呢我一共考了{}次，单次最高是{}，阅读{}，语法{}，数学{}，拼分最高是{}".format(student.sat_test_time, student.best_sat,
                                                             student.one_time_best_sat()[0],
                                                             student.one_time_best_sat()[1],
                                                             student.one_time_best_sat()[2], student.best()))

# AP portion
print("我总共考了{}门ap,分别是{}".format(student.ap_count, student.ap))
